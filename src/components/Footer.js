                    ...
                    <div className="footer__text d-flex justify-content-end">
                        <div className="footer__position__text d-flex flex-column">
                            <div className="footer__nav d-flex gap-4">
                                <Button variant="link" className="nav__button">Home</Button>
                                <Button variant="link" className="nav__button">Prices</Button>
                                <Button variant="link" className="nav__button">Blog</Button>
                                <Button variant="link" className="nav__button">Questions</Button>
                                <Button variant="link" className="nav__button">Reviews</Button>
                            ...
                            <div className="footer__location">
                                <div className="footer__location__title">Как нас найти:</div>
